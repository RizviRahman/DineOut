export default function Summary({ord_sum}){
    return (
        <div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-cardbg rounded-lg p-4 relative overflow-hidden">
                    <div className="text-5xl font-bold text-yellow-500 mb-2">{ord_sum.totalOrders}</div>
                    <div
                ...
                {/* Pending Orders */}
                <div className="bg-cardbg rounded-lg p-4 relative overflow-hidden">
                    <div className="text-5xl font-bold text-red-500 mb-2">{ord_sum.pendingOrders}</div>
                    <div
                ...
                {/* Delivered Orders */}
                <div className="bg-cardbg rounded-lg p-4 relative overflow-hidden">
                    <div className="text-5xl font-bold text-green-500 mb-2">{ord_sum.deliveredOrders}</div>
                    <div
